...
HD_PWD='C:/VivadoProjects/fullAdder2Bit_Structural/fullAdder2Bit_Structural.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fullAdder_2Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fullAdder_2Bit.tcl
