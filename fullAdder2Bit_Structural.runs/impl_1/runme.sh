...
HD_PWD='C:/VivadoProjects/fullAdder2Bit_Structural/fullAdder2Bit_Structural.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fullAdder_2Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fullAdder_2Bit.tcl -notrace
